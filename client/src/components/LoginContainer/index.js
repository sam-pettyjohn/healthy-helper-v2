    ...
    return (
      <div>
        ...
        >
          ...
          >
            <MenuItem onClick={this.closeDropdown} className="menuItemLi">
              <span><i class="fas fa-user-plus" /></span>
              Sign Up
            </MenuItem>
          </Button>
        </Menu>
          ...
          <FormControl className="popUpPrompt">
            ...
            <FormGroup className="formatPreferences">
              <Grid container spacing={24}>
                <Grid item sm={6} className="dietRestrictionFlexing dietRestrictionOptions1">
                  <FormControlLabel
                    control={
                      <Switch
                ...
                <Grid item sm={6} className="dietRestrictionFlexing dietRestrictionOptions2">
                  <FormControlLabel
                    control={
                      <Switch
